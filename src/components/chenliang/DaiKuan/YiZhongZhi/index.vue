<!-- 贷前管理-贷款-已终止 -->
<template>
		<el-main style="background:#F9F9F9;padding: 0 !important;">
			<div class="lieBiao">
			...
			<template>
				<el-table class="ju" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%;">
					...
					<el-table-column prop="huankuan" label="还款方式" width="80">
					</el-table-column>
					<el-table-column prop="jiekuan" label="借款期限" width="80">
					</el-table-column>
					<el-table-column prop="daikuan" label="贷款类型" width="80">
					</el-table-column>
					<el-table-column prop="shenpi" label="审批金额" width="80">
					</el-table-column>
					<el-table-column prop="" label="状态" width="85">
						<template slot-scope="scope">
							<div class="shenhe">
								<div class="boHui">{{ scope.row.zhuangtai }}</div>
								<div>
					...
					<el-table-column prop="chushen" label="初审" width="65">
					</el-table-column>
					<el-table-column prop="fushen" label="复审" width="65">
					</el-table-column>
					<el-table-column prop="" label="操作" width="65">
						<template slot-scope="scope">
							<router-link to="/index/ChaKan" tag="div">{{ scope.row.caozuo }}</router-link>
						</template>
					</el-table-column>
				</el-table>
			</template>
