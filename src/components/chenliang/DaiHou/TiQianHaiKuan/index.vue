...
<template>
	<el-container>
		<el-main>
			<div class="jiekuan"><i class="el-icon-s-home"></i>首页/贷前管理/提前还款</div>
			...
			<template>
				<el-table class="ju" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%;">
					...
					<el-table-column prop="shenpi" label="贷款类型" width="70">
					</el-table-column>
					<el-table-column prop="jianyi" label="还款方式" width="85">
					</el-table-column>
					<el-table-column prop="chushen" label="是否放款" width="80">
					</el-table-column>
					<el-table-column prop="fushen" label="放款时间" width="70">
					</el-table-column>
					<el-table-column prop="fangshi" label="放款方式" width="60">
					</el-table-column>
					<el-table-column prop="zhuang" label="状态" width="100">
					</el-table-column>
					<el-table-column prop="" label="操作" width="90">
						<template slot-scope="scope">
							<router-link to="/index/TiQianHaiKuanCha" tag="div">{{ scope.row.caozuo }}</router-link>
							<router-link to="/index/TiQianHaiKuanBanLi" tag="div">{{ scope.row.tiqian }}</router-link>
						</template>
					</el-table-column>
				</el-table>
			</template>
