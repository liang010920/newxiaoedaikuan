...
<template>
	<el-container>
		...
		<el-main>
			<div class="jiekuan"><i class="el-icon-s-home"></i>首页/贷后管理/还款管理</div>
			...
			<template>
				<el-table class="ju" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%;">
					...
					<el-table-column label="借款编号" width="90">
					...
					<el-table-column prop="edu" label="申请额度" width="65">
					</el-table-column>
					<el-table-column prop="huankuan" label="审批金额" width="90">
					</el-table-column>
					<el-table-column prop="jiekuan" label="合同金额" width="80">
					</el-table-column>
					<el-table-column prop="daikuan" label="借款期限" width="70">
					</el-table-column>
					...
					<el-table-column prop="jianyi" label="还款方式" width="85">
						<!-- <template slot-scope="scope">
							<div class="shenhe">
								<div>{{ scope.row.zhuangtai }}</div>
								<div class="boHui">{{ scope.row.bohui }}</div>
								<div>
									<span type="text" @click="dialogTableVisible = true">
										<span type="primary" @click="openFullScreen2">
											{{ scope.row.xiangqing }}
										</span>
									</span>
									<el-dialog title="审核详情" :visible.sync="dialogTableVisible">
										<el-table :data="gridData">
											<el-table-column property="date" label="审核时间" width="100"></el-table-column>
											<el-table-column property="zhuangtai" label="状态" width="80"></el-table-column>
											<el-table-column property="renyuan" label="审核人员" width="80"></el-table-column>
											<el-table-column property="jieguo" label="审核结果" width="80"></el-table-column>
											<el-table-column label="反馈详情">
												<template slot-scope="scope">
													<div>{{ scope.row.fankui }}</div>
													<div align="left">{{ scope.row.edu }}</div>
												</template>
											</el-table-column>
										</el-table>
									</el-dialog>
					...
					<el-table-column prop="shifou" label="放款时间" width="80">
					</el-table-column>
					<el-table-column prop="chushen" label="放款通道" width="80">
					</el-table-column>
					<el-table-column prop="fushen" label="状态" width="65">
					</el-table-column>
					
					<el-table-column prop="" label="操作" width="85">
						<template slot-scope="scope">
							<router-link to="/index/HaiKuanGuanLiCha" tag="div">{{ scope.row.caozuo }}</router-link>
							<router-link to="/index/HaiKuanGuanLiLvRu" tag="div">{{ scope.row.lvru }}</router-link>
						</template>
					</el-table-column>
				</el-table>
			</template>
