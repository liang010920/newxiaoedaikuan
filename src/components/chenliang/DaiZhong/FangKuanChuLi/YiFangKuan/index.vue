				...
				<el-table class="ju" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%;">
					...
					<el-table-column prop="" label="操作" width="85">
						<template slot-scope="scope">
							<div><router-link tag="span" to="/index/DaiZhong/FangKuanChuLi/FangKuanDengJi">
							{{scope.row.caozuo}}</router-link></div>
							<div><router-link to="/index/DaiZhong/FangKuanChuLi/WeiTuoChuLi" tag="span">{{scope.row.caozuo2}}</router-link></div>
						</template>
					</el-table-column>
				</el-table>
			</template>
