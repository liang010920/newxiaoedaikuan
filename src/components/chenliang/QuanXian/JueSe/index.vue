...
<template>
	<el-container>
		<el-main>
			<div align="left">
				<i class="el-icon-s-home"></i>首页/权限/角色管理
				...
				<el-dialog title="添加角色" :visible.sync="dialogTableVisible">
					<div>
						<table width="100%" class="addBuMen">
							<tr height="40px">
								<td align="right"><span>*</span>角色名称：</td>
								<td><input type="text"></td>
							</tr>
							<tr>
								<td align="right"><span>*</span>角色描述：</td>
			...
			<template>
				<el-table :data="tableData" border style="width: 100%" align="center">
					...
					<el-table-column prop="miaoshu" label="角色描述" width="180">
					</el-table-column>
					...
					<el-table-column prop="" label="操作">
						<template slot-scope="scope">
							<div>
								<router-link tag="span" to="/index/QuanXian/JueSe/QuanXianSheZhi">
									<span class="bianju">{{scope.row.quanxian}}</span>
								</router-link>
								<span class="bianju" @click="dialogTableVisible2 = true">{{scope.row.bianji}}</span>
								<el-dialog title="编辑角色" :visible.sync="dialogTableVisible2">
									<div>
										<table width="100%" class="addBuMen">
											<tr height="40px">
												<td align="right"><span>*</span>角色名称：</td>
